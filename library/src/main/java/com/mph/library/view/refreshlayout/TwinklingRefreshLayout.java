package com.mph.library.view.refreshlayout;
...
import com.mph.library.view.refreshlayout.Footer.BottomProgressView;
import com.mph.library.view.refreshlayout.header.GoogleDotView;
import com.mph.library.view.refreshlayout.utils.ScrollingUtil;
...
public class TwinklingRefreshLayout extends RelativeLayout {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWaveHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_wave_height, (int) Kits.Dimens.dip2px(context, 120));
        mHeadHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_head_height, (int) Kits.Dimens.dip2px(context, 80));
        mBottomHeight = a.getDimensionPixelSize(R.styleable.TwinklingRefreshLayout_tr_bottom_height, (int) Kits.Dimens.dip2px(context, 60));
    ...
    public void setWaveHeight(float waveHeightDp) {
        this.mWaveHeight = Kits.Dimens.dip2px(getContext(), waveHeightDp);
    }
    ...
    public void setHeaderHeight(float headHeightDp) {
        this.mHeadHeight = Kits.Dimens.dip2px(getContext(), headHeightDp);
    }
    ...
    public void setBottomHeight(float bottomHeightDp) {
        this.mBottomHeight = Kits.Dimens.dip2px(getContext(), bottomHeightDp);
    }
    ...
    public void setOverScrollHeight(float overScrollHeightDp) {
        this.mOverScrollHeight = Kits.Dimens.dip2px(getContext(), overScrollHeightDp);
    }
