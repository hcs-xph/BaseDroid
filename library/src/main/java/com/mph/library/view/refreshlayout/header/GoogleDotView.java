package com.mph.library.view.refreshlayout.header;
...
import com.mph.library.view.refreshlayout.IHeaderView;
import com.mph.library.view.refreshlayout.OnAnimEndListener;
...
public class GoogleDotView extends View implements IHeaderView {
    ...
    private void init() {
        r = Kits.Dimens.dip2px(getContext(), 4);
